...
const ClayArt = ({ id, colors, type = "earring" }) => (
  <svg viewBox="0 0 220 180" className="w-full h-full">
    ...
    {type === "earring" && (
      <>
        <circle cx="110" cy="42" r="12" fill={`url(#body-${id})`} />
        <path
          d="M110 54 L80 90 L110 125 L140 90 Z"
          fill={`url(#body-${id})`}
          stroke="#8B6A1E"
        />
    ...
    {type === "set" && (
      <>
        <path
          d="M60 45 C75 20 145 20 160 45"
          stroke="#8B6A1E"
          strokeWidth="4"
          fill="none"
        />
        <circle cx="110" cy="82" r="28" fill={`url(#body-${id})`} />
        <circle cx="70" cy="118" r="12" fill={`url(#body-${id})`} />
        <circle cx="150" cy="118" r="12" fill={`url(#body-${id})`} />
      </>
    )}
  </svg>
);
...
const COLLECTIONS = [
  {
    ...
    bg: "card-peach",
    colors: { light: "#F7C8A5", dark: "#B45E32" },
    type: "necklace",
  },
  {
    title: "Terracotta",
    ...
    bg: "card-blush",
    colors: { light: "#E8A06C", dark: "#8A4420" },
    type: "earring",
  },
  {
    title: "Hand Painted",
    ...
    bg: "card-mint",
    colors: { light: "#F9D6AE", dark: "#A86131" },
    type: "set",
  },
  {
    title: "Bridal Clay",
    ...
    bg: "card-sage",
    colors: { light: "#E9B690", dark: "#8D4A23" },
    type: "necklace",
  },
  {
    title: "Contemporary",
    ...
    bg: "card-rose",
    colors: { light: "#F5C7A7", dark: "#B15C2C" },
    type: "earring",
  },
  {
    ...
    bg: "card-ivory",
    colors: { light: "#F0C79B", dark: "#995529" },
    type: "set",
  },
];
    ...
    <section className="relative watercolor-bg paper-texture overflow-hidden py-20 md:py-28 lg:py-32 px-4 md:px-8 lg:px-10">
      ...
      <div className="max-w-[1100px] mx-auto text-center relative z-10">
        ...
        <h1 className="mt-6 font-serif text-[42px] md:text-[68px] maroon-text leading-none">
          Clay <span className="italic gold-text">Jewellery</span>
        </h1>

        <p className="mt-8 max-w-2xl mx-auto text-[#5A3A3F] leading-8">
          Handcrafted by skilled artisans using traditional techniques, our clay
          jewellery celebrates India's artistic heritage with contemporary
          elegance.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-5">
          <a
            href="#collections"
            className="btn-primary-gradient px-9 py-4 rounded-full text-center inline-block"
          >
            EXPLORE COLLECTION
          </a>
          ...
          <a
            href="#consult"
            className="btn-outline-gold px-9 py-4 rounded-full text-center inline-block"
          >
            BOOK CONSULTATION
          </a>
        </div>
    ...
    <section className="relative py-20 bg-[#FDF7EF] paper-texture">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <h2 className="font-serif text-5xl maroon-text">
          Where <span className="italic gold-text">Art Meets Tradition</span>
        </h2>
    ...
    >
      <div className="max-w-[1350px] mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-5xl maroon-text">
            Explore Our <span className="italic gold-text">Clay Collections</span>
          </h2>

          <p className="mt-6 max-w-3xl mx-auto text-[#6B4B4F] leading-8">
            Every collection is handcrafted individually, making every creation
            unique. Select a style that resonates with your personality and
            customise it during your consultation.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
          {COLLECTIONS.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className={`${item.bg} rounded-[34px] overflow-hidden shadow-xl border border-[#E9DAC5] flex flex-col justify-between`}
            >
              <div>
                <div className="aspect-[4/3] flex items-center justify-center p-10">
                  <ClayArt id={index} colors={item.colors} type={item.type} />
                </div>
                ...
                <div className="px-8 pb-8">
                  ...
                  <p className="mt-4 text-[#6B4B4F] leading-7">{item.desc}</p>
                </div>
              </div>
              ...
              <div className="px-8 pb-8">
                <a
                  href="#consult"
                  className="btn-outline-gold px-6 py-3 rounded-full inline-block text-center w-full sm:w-auto"
                >
                  Book Consultation
                </a>
              </div>
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-5xl mt-5 maroon-text">
            Crafted With <span className="gold-text italic">Passion</span>
          </h2>
        </div>
          ...
          {features.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-5">
                <div className="w-16 h-16 rounded-full bg-[#F5E2CA] flex items-center justify-center shrink-0">
                  <LotusLogo size={34} />
                </div>
                ...
                <div>
                  ...
                  <p className="mt-3 text-[#6B4B4F] leading-7">{item.text}</p>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-5xl maroon-text">
              Every Piece Has <span className="gold-text italic">A Story</span>
            </h2>

            <p className="mt-8 text-[#6B4B4F] leading-8">
              Our artisans spend hours carefully moulding, carving, firing and
              hand-painting every ornament. No two creations are ever exactly
              alike, making every Kamalavasinii clay jewellery piece truly
              exclusive.
            </p>

            <a
              href="#consult"
              className="btn-primary-gradient mt-10 px-8 py-4 rounded-full inline-block text-center"
            >
              Book Consultation
            </a>
          </motion.div>
    ...
    <section className="py-24 watercolor-bg paper-texture">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="font-serif text-5xl maroon-text">
            From <span className="gold-text italic">Vision</span> To Creation
          </h2>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="bg-white rounded-[26px] shadow-lg border border-[#E7D8C5] p-8 flex-1">
                ...
                <p className="mt-4 text-[#6B4B4F] leading-8">{step.text}</p>
              </div>
            </motion.div>
          ))}
        </div>
...
function ConsultationCTA() {
  return (
    <section id="consult" className="relative py-28 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#5A1422] via-[#6D2132] to-[#8B6A1E]" />

      <LotusMotif className="absolute left-[-40px] top-10 w-[260px] h-[260px] opacity-10" />
      <LotusMotif className="absolute right-[-50px] bottom-0 w-[320px] h-[320px] opacity-10" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
        ...
        <h2 className="mt-8 font-serif text-5xl md:text-6xl text-white">
          Create Your{" "}
          <span className="text-[#EAC77A] italic">Dream Clay Jewellery</span>
        </h2>

        <p className="mt-8 text-[#F6E9DD] leading-8 text-lg max-w-3xl mx-auto">
          Every handcrafted creation is tailored to your personality, colours and
          celebration. Book a consultation with our artisans and let us design
        ...
        <div className="mt-12 flex flex-col sm:flex-row justify-center gap-6">
          <a
            href="/contact"
            className="bg-[#EAC77A] hover:bg-[#D6B05A] transition-colors text-[#5A1422] px-10 py-4 rounded-full font-semibold inline-block text-center"
          >
            Book Consultation
          </a>
          ...
          <a
            href="/contact"
            className="border border-white text-white hover:bg-white hover:text-[#5A1422] transition-colors px-10 py-4 rounded-full inline-block text-center"
          >
            Talk To Our Team
          </a>
        </div>
