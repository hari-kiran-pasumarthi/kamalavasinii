      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl bg-[#F7EFE5]">
              <Image
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -right-8 bg-white rounded-3xl shadow-2xl p-8 border border-[#EFE1CC] z-10"
            >
          ...
          >
            ...
            <p className="uppercase tracking-[0.45em] text-[#B8860B] text-sm font-medium">
              OUR HERITAGE
            </p>
